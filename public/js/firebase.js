...
// Ensure an auth user exists (anonymous OK)
...
// Save FCM token on /users/{uid}
export async function registerFcmToken() {
  try {
    const current = auth.currentUser || (await ensureAuth());
    // TODO: replace with your Web Push certificate key pair (VAPID) from Firebase Project Settings > Cloud Messaging
